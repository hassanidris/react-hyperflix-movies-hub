...
const SearchField = () => {
  ...
  return(
    <form>   
    <label for="default-search" className={classNameLabel}>Search</label>
    <div className="relative">
        ...
        <input type="search" id="default-search" className={classNameInput} placeholder="Search for Movies..." />
