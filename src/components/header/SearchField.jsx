...
const SearchField = () => {
  ...
  return(
    ...
    <div className="relative">
        ...
        <input type="search" id="default-search" className="block w-full p-4 ps-8 text-sm text-gray-900 border border-m_lightGrey rounded-lg bg-m_lightGrey focus:ring-m_gold focus:bg-m_white focus:border-m_gold placeholder-m_gold" placeholder="Search for a movie..." value={query}
